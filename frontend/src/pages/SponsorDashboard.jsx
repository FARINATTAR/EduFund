...
// import { User, Download, FileText, Heart } from 'lucide-react';
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-900 text-white p-8 flex items-center justify-center">
//       <div className="w-full max-w-3xl bg-white text-gray-800 rounded-xl shadow-lg p-8 space-y-6">
//         {/* Heading */}
//         <h2 className="text-4xl font-extrabold text-center text-slate-900 mb-2">
...
//         {/* Sponsor Info */}
//         <div className="bg-gradient-to-r from-amber-100 to-yellow-50 p-6 rounded-xl shadow-inner flex items-center space-x-4">
...
//             className="flex items-center justify-center bg-pink-500 text-white py-3 px-4 rounded-lg hover:bg-pink-600 transition-all shadow-md"
//           >
//             <Heart className="w-5 h-5 mr-2" /> Donate Again
//           </Link>

//           <Link
//             to={`/sponsor/${id}/donations`}
//             className="flex items-center justify-center bg-blue-500 text-white py-3 px-4 rounded-lg hover:bg-blue-600 transition-all shadow-md"
//           >
//             <FileText className="w-5 h-5 mr-2" /> View Donations
//           </Link>

//           <a
//             href={`http://localhost:5000/api/sponsors/${id}/donations/export`}
//             className="flex items-center justify-center bg-purple-500 text-white py-3 px-4 rounded-lg hover:bg-purple-600 transition-all shadow-md"
//             download
//           >
